...
stream=io.StringIO(newline='');w=csv.writer(stream);w.writerow(['Mes','Línea','Actividad','Tipo','Frecuencia','Estado','Fecha','Hora','Zona horaria','Sede','Responsable funcional','Objetivo','Nivel','Ponentes','Cupo','Presupuesto PEN','Registro']);w.writerows(rows)
